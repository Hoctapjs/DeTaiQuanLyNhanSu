...
public enum AttendanceStatus { present, absent, late, leave, ot, completed }//Thêm completed
public enum RequestCategory { ot,leave, resignation, business_trip, incident, proposal, other }
