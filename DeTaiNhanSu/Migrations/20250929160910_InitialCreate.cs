    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RewardPenaltyTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bhyt = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Bhtn = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuranceProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsuranceProfiles_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Salaries_PayrollRuns_PayrollRunId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalaryItems_Salaries_SalaryId",
                        column: x => x.SalaryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecidedAt = table.Column<DateOnly>(type: "date", nullable: false),
                    DecidedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RewardPenalties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RewardPenalties_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RewardPenalties_RewardPenaltyTypes_TypeId",
                        column: x => x.TypeId,
                        principalTable: "RewardPenaltyTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RewardPenalties_Users_DecidedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsuranceProfiles_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RewardPenalties_DecidedBy",
                table: "RewardPenalties",
                column: "DecidedBy");

            migrationBuilder.CreateIndex(
                name: "IX_RewardPenalties_EmployeeId",
                table: "RewardPenalties",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_RewardPenalties_TypeId",
                table: "RewardPenalties",
                column: "TypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Salaries_EmployeeId_PayrollRunId",
                table: "Salaries",
                columns: new[] { "EmployeeId", "PayrollRunId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Salaries_PayrollRunId",
                table: "Salaries",
                column: "PayrollRunId");

            migrationBuilder.CreateIndex(
                name: "IX_SalaryItems_SalaryId",
                table: "SalaryItems",
                column: "SalaryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingRecords_EmployeeId_CourseId",
                table: "TrainingRecords",
                columns: new[] { "EmployeeId", "CourseId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrainingRecords_EvaluatedBy",
                table: "TrainingRecords",
                column: "EvaluatedBy");
